    ...
    <main class="qfit-main">
        <section class="qfit-glass-card qfit-form-card qfit-centered-form-wrapper">
            ...
            <div class="qfit-register-header">
                ...
                <p>
                    Please use your <strong>official @qmail.cuny.edu email</strong> and upload your Queens College ID
            ...
            <form class="qfit-registration-form-grid"
                ...
                <div class="qfit-column qfit-form-section">
                    ...
                    <div class="qfit-form-group">
                        ...
                        <input type="hidden" name="primaryGoal" id="primaryGoal" required
                               value="<c:out value='${requestScope.primaryGoal}'/>">
                    </div>

                    <div class="qfit-form-group">
                        <label>Experience Level</label>
                        <div class="qfit-button-group" id="expGroup">
                            <button type="button" class="qfit-btn qfit-btn-experience" data-level="beginner">Beginner</button>
                            <button type="button" class="qfit-btn qfit-btn-experience" data-level="intermediate">Intermediate</button>
                            <button type="button" class="qfit-btn qfit-btn-experience" data-level="advanced">Advanced</button>
                        </div>
                        <input type="hidden" name="experienceLevel" id="experienceLevel" required
                               value="<c:out value='${requestScope.experienceLevel}'/>">
                    </div>
                </div>
                ...
                <div class="qfit-column qfit-upload-column">
                    ...
                    <div class="qfit-form-group">
                        <label>Queens College ID (Front)</label>
                        <input type="file" name="idFront" accept="image/*" required>
                    </div>

                    <div class="qfit-form-group">
                        <label>Queens College ID (Back)</label>
                ...
                <div class="qfit-form-actions">
                    ...
                    <p class="qfit-register-footer-link">
                        Already registered?
                        <a href="${pageContext.request.contextPath}/index.jsp">Back to Log In</a>
                    </p>
                </div>
