        ...
        <c:choose>
            <c:when test="${not empty plan}">
                ...
                <form method="post" action="ProcessLogWorkoutServlet" class="qfit-log-form qfit-glass-card">
                    ...
                    <%-- ✅ ADDED: so ProcessLogWorkoutServlet can store a friendly name in history --%>
                    <input type="hidden" name="planName" value="<c:out value='${plan.name}'/>">

                    <%-- ✅ ADDED (TEMP): until you calculate real duration, store a default --%>
