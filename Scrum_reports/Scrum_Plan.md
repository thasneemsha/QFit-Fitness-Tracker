...
| Name & Role | Contribution Focus | Burndown Chart URL |
| :--- | :--- | :--- |
| **Sonu** - Scrum Master | Updated use case diagrams; adjusted scope (removed location modules). | [Sprint2](https://1drv.ms/x/c/9dd64dedc5739ac5/IQD33To_TDBoToRZw-4r3UgmAUMBw45lPDJqbme-rqMo04k?e=KMWegx) |
...
| **Ali** - Front-End Developer | Developed **`index.jsp` (Login Page)**,**`register.jsp`**,**`pendingAproval.jsp`**, and the **`adminDashboard.jsp`**. | [sprint-Ali](https://cuny-my.sharepoint.com/:x:/g/personal/thasneem_mohamed29_qmail_cuny_edu/IQBsuq-rGAzxQb49GqtcMnvAAYKY5oklx3uytTLhZdOZoRs?e=yKv2QG&nav=MTVfezAwMDAwMDAwLTAwMDEtMDAwMC0wMDAwLTAwMDAwMDAwMDAwMH0) | [name](link)
<br>
...
| Name & Role | Contribution Focus | Burndown Chart URL | code base |
| :--- | :--- | :--- | :--- |
| **Sonu** - Scrum Master/Backend | Implemented **`LoginServlet`** and **`RegisterServlet`** logic. Tested JDBC connection and servlet routing. | [sprint6](https://1drv.ms/x/c/9dd64dedc5739ac5/IQAvfSdbj4r6RqaEpIeR2nNxASyWlspubsrxVInAZDT3MzM?e=QSz5t2) |[AdminDashboardServlet.java](https://github.com/thasneemsha/QFit-Fitness-Tracker/blob/f727432e0f42661fa53db24b88297cc8e2a777ba/Sonu's_Servlet_Contributions/AdminDashboardServlet.java) [CreateWorkoutPlanServlet.java](https://github.com/thasneemsha/QFit-Fitness-Tracker/blob/f727432e0f42661fa53db24b88297cc8e2a777ba/Sonu's_Servlet_Contributions/CreateWorkoutPlanServlet.java) 
[EditPlanServlet.java](https://github.com/thasneemsha/QFit-Fitness-Tracker/blob/f727432e0f42661fa53db24b88297cc8e2a777ba/Sonu's_Servlet_Contributions/EditPlanServlet.java)
...
| Name & Role | Contribution Focus | Burndown Chart URL | code base |
| :--- | :--- | :--- | :--- |
| **Sonu** - Scrum Master/Backend | Completed remaining servlet logic and testing. Finalized Sprint reports and final workout-flow. Cleaned and organized the final GitHub repository. | [sprint7](https://1drv.ms/x/c/9dd64dedc5739ac5/IQAturmzf-b4Qb6CPy_NU5uFAYVwEb3riX-9CAhE0yAgwv8?e=dGysIo)|[PendingApprovalServlet.java](https://github.com/thasneemsha/QFit-Fitness-Tracker/blob/f727432e0f42661fa53db24b88297cc8e2a777ba/Sonu's_Servlet_Contributions/PendingApprovalServlet.java)
[ProfileServlet.java](https://github.com/thasneemsha/QFit-Fitness-Tracker/blob/f727432e0f42661fa53db24b88297cc8e2a777ba/Sonu's_Servlet_Contributions/ProfileServlet.java)
