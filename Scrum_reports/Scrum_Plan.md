...
| Name & Role | Contribution Focus | Burndown Chart URL | code base |
| :--- | :--- | :--- | :--- |
| **Sonu** - Scrum Master/Backend | Completed remaining servlet logic and testing. Finalized Sprint reports and final workout-flow. Cleaned and organized the final GitHub repository. |  | [PendingApprovalServlet](https://github.com/thasneemsha/QFit-Fitness-Tracker/blob/f727432e0f42661fa53db24b88297cc8e2a777ba/Sonu's_Servlet_Contributions/PendingApprovalServlet.java)
